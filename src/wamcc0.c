...
Begin_Private_Pred
      ...
      put_constant(X696E,2,"in")
      call(Pred_Name(X6F70,3),0,1,"op",3)          /* begin sub 1 */
      put_integer(690,0)
      put_constant(X7866,1,"xf")
      put_constant(X6E6F5F6F707432,2,"no_opt2")
      call(Pred_Name(X6F70,3),0,2,"op",3)          /* begin sub 2 */
      put_integer(650,0)
      put_constant(X796678,1,"yfx")
      put_constant(X3A,2,":")
      call(Pred_Name(X6F70,3),0,3,"op",3)          /* begin sub 3 */
      put_integer(600,0)
      put_constant(X796678,1,"yfx")
      put_constant(X26,2,"&")
      call(Pred_Name(X6F70,3),0,4,"op",3)          /* begin sub 4 */
      put_integer(550,0)
      put_constant(X786678,1,"xfx")
      put_constant(X2E2E,2,"..")
      call(Pred_Name(X6F70,3),0,5,"op",3)          /* begin sub 5 */
      put_integer(400,0)
      put_constant(X796678,1,"yfx")
      put_list(3)
      unify_constant(X2F3E,"/>")
      unify_nil
      put_list(2)
      unify_constant(X2F3C,"/<")
      unify_x_value(3)
      call(Pred_Name(X6F70,3),0,6,"op",3)          /* begin sub 6 */
      cut_y(0)
      deallocate
      proceed
...
Begin_Private_Pred
      ...
      put_constant(X786678,1,"xfx")
      put_list(3)
      unify_constant(X233E3D,"#>=")
      unify_nil
      put_list(2)
      unify_constant(X233E,"#>")
      unify_x_value(3)
      put_list(3)
      unify_constant(X233C3D,"#<=")
      unify_x_value(2)
      put_list(2)
      unify_constant(X233C,"#<")
      unify_x_value(3)
      put_list(3)
      unify_constant(X235C3D,"#\\=")
      unify_x_value(2)
      put_list(2)
      unify_constant(X233D,"#=")
      unify_x_value(3)
      call(Pred_Name(X6F70,3),0,1,"op",3)          /* begin sub 1 */
      cut_y(0)
      deallocate
