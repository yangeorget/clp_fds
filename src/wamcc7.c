/****************************************************************************
Prolog to Wam Compiler - Version 1.2
...
Begin_Public_Pred
      allocate(1)
      get_y_variable(0,0)
      put_constant(X6669635F6F7574,2,"fic_out")
      put_x_variable(0,1)
      builtin_2(g_read,2,1)
      call(Pred_Name(X74656C6C,1),0,1,"tell",1)          /* begin sub 1 */
      put_y_value(0,0)
      call(Pred_Name(X77616D5F656D69745F6C73745F70726564,1),1,2,"wam_emit_lst_pred",1)          /* begin sub 2 */
      deallocate
...
label(4)
      ...
      unify_y_variable(2)
      get_y_bc_reg(1)
      call(Pred_Name(X77616D5F656D69745F70726564,2),1,1,"wam_emit_pred",2)          /* begin sub 1 */
      put_y_value(2,0)
      call(Pred_Name(X77616D5F656D69745F6C73745F666463,1),1,2,"wam_emit_lst_fdc",1)          /* begin sub 2 */
      cut_y(1)
      put_y_value(0,0)
      deallocate
...
label(1)
      ...
      put_y_value(3,0)
      put_y_value(2,1)
      call(Pred_Name(X77616D5F656D69745F707265645F2461757831,2),1,3,"wam_emit_pred_$aux1",2)          /* begin sub 3 */
      put_constant(X2E,0,".")
      ...
      put_x_variable(2,2)
      call(Pred_Name(X77616D5F656D6974,3),1,7,"wam_emit",3)          /* begin sub 7 */
      cut_y(0)
      deallocate
...
Begin_Private_Pred
      ...
      put_y_value(1,0)
      call(Pred_Name(X77616D5F656D69745F707265645F2461757832,1),1,2,"wam_emit_pred_$aux2",1)          /* begin sub 2 */
      cut_y(0)
      put_constant(X6465665F646972656374697665,0,"def_directive")
      deallocate
...
label(1)
      ...
      put_y_value(1,1)
      put_y_variable(0,2)
      call(Pred_Name(X77616D5F656D69745F707265645F2461757833,3),1,3,"wam_emit_pred_$aux3",3)          /* begin sub 3 */
      put_structure(X2F,2,1,"/")
      unify_y_local_value(2)
      unify_y_local_value(1)
      put_structure(X6465665F707265646963617465,2,0,"def_predicate")
      unify_x_value(1)
...
Begin_Private_Pred
      ...
      cut_y(1)
      put_y_value(0,0)
      get_constant(X7075626C6963,0,"public")
      deallocate
      proceed

label(1)
      trust_me_else_fail
      get_constant(X70726976617465,2,"private")
      proceed
...
label(4)
      ...
      get_y_bc_reg(5)
      put_y_variable(4,1)
      call(Pred_Name(X77616D5F656D69745F2461757834,2),1,1,"wam_emit_$aux4",2)          /* begin sub 1 */
      cut_y(5)
      put_y_value(4,0)
      put_y_value(3,1)
      put_y_variable(1,2)
      call(Pred_Name(X77616D5F656D6974,3),1,2,"wam_emit",3)          /* begin sub 2 */
      put_y_value(2,0)
...
label(7)
      ...
      put_y_value(0,0)
      call(Pred_Name(X77616D5F656D69745F2461757835,1),1,3,"wam_emit_$aux5",1)          /* begin sub 3 */
      put_constant(X77616D287E772C20,0,"wam(~w, ")
      put_list(1)
      unify_y_value(0)
      unify_nil
      deallocate
...
label(8)
      ...
      put_x_value(1,0)
      call(Pred_Name(X77616D5F656D69745F2461757836,1),1,4,"wam_emit_$aux6",1)          /* begin sub 4 */
      call(Pred_Name(X6E6C,0),0,5,"nl",0)          /* begin sub 5 */
      put_integer(4,0)
...
#define ASCII_PRED "wam_emit_lst_fdc"
#define PRED       X77616D5F656D69745F6C73745F666463
#define ARITY      1
...
label(4)
      ...
      call(Pred_Name(X6E6C,0),0,1,"nl",0)          /* begin sub 1 */
      call(Pred_Name(X6E6C,0),0,2,"nl",0)          /* begin sub 2 */
      put_structure(X6465665F66645F696E7374616C6C5F636F6E73747261696E74,1,0,"def_fd_install_constraint")
      unify_y_value(2)
      call(Pred_Name(X777269746571,1),0,3,"writeq",1)          /* begin sub 3 */
      put_constant(X2E,0,".")
      call(Pred_Name(X7772697465,1),0,4,"write",1)          /* begin sub 4 */
      call(Pred_Name(X6E6C,0),0,5,"nl",0)          /* begin sub 5 */
      call(Pred_Name(X6E6C,0),0,6,"nl",0)          /* begin sub 6 */
      put_structure(X6C6162656C,1,1,"label")
      unify_integer(0)
      put_list(0)
      unify_x_value(1)
      unify_y_value(4)
      ...
      put_x_variable(2,2)
      call(Pred_Name(X77616D5F656D6974,3),1,7,"wam_emit",3)          /* begin sub 7 */
      call(Pred_Name(X77616D5F66696E69725F656D697373696F6E5F696E7374,0),1,8,"wam_finir_emission_inst",0)          /* begin sub 8 */
      call(Pred_Name(X6E6C,0),0,9,"nl",0)          /* begin sub 9 */
      call(Pred_Name(X6E6C,0),0,10,"nl",0)          /* begin sub 10 */
      put_structure(X6465665F66645F636F6E73747261696E74,1,0,"def_fd_constraint")
      unify_y_value(2)
      call(Pred_Name(X777269746571,1),0,11,"writeq",1)          /* begin sub 11 */
      put_constant(X2E,0,".")
      ...
      put_constant(X74,1,"t")
      put_x_variable(2,2)
      call(Pred_Name(X77616D5F656D6974,3),1,15,"wam_emit",3)          /* begin sub 15 */
      call(Pred_Name(X77616D5F66696E69725F656D697373696F6E5F696E7374,0),1,16,"wam_finir_emission_inst",0)          /* begin sub 16 */
      call(Pred_Name(X6E6C,0),0,17,"nl",0)          /* begin sub 17 */
      call(Pred_Name(X6E6C,0),0,18,"nl",0)          /* begin sub 18 */
      put_structure(X6465665F66645F726574726163745F636F6E73747261696E74,1,0,"def_fd_retract_constraint")
      unify_y_value(2)
      call(Pred_Name(X777269746571,1),0,19,"writeq",1)          /* begin sub 19 */
      put_constant(X2E,0,".")
      call(Pred_Name(X7772697465,1),0,20,"write",1)          /* begin sub 20 */
      call(Pred_Name(X6E6C,0),0,21,"nl",0)          /* begin sub 21 */
      call(Pred_Name(X6E6C,0),0,22,"nl",0)          /* begin sub 22 */
      put_structure(X6C6162656C,1,1,"label")
      unify_integer(0)
      put_list(0)
      unify_x_value(1)
      ...
      put_constant(X74,1,"t")
      put_x_variable(2,2)
      call(Pred_Name(X77616D5F656D6974,3),1,23,"wam_emit",3)          /* begin sub 23 */
      call(Pred_Name(X77616D5F66696E69725F656D697373696F6E5F696E7374,0),1,24,"wam_finir_emission_inst",0)          /* begin sub 24 */
      put_y_value(0,0)
      deallocate
      execute(Pred_Name(X77616D5F656D69745F6C73745F666463,1),1,"wam_emit_lst_fdc",1)
...
label(5)
      ...
      unify_integer(255)
      get_constant(X6E65636B5F637574,1,"neck_cut")
      proceed
...
label(7)
      ...
      unify_integer(255)
      get_structure(X6765745F785F7661726961626C65,2,1,"get_x_variable")
      unify_integer(255)
      unify_integer(255)
      proceed
...
Begin_Init_Tables(wamcc7)
 ...
 Define_Atom(X5D292E,"]).")
 Define_Atom(X77616D5F656D69745F6C73745F666463,"wam_emit_lst_fdc")
 Define_Atom(X63737472,"cstr")
 Define_Atom(X6465665F66645F696E7374616C6C5F636F6E73747261696E74,"def_fd_install_constraint")
 Define_Atom(X6465665F66645F636F6E73747261696E74,"def_fd_constraint")
 Define_Atom(X6465665F66645F726574726163745F636F6E73747261696E74,"def_fd_retract_constraint")
 ...
 Define_Pred(X77616D5F656D69745F6C73745F666463,1,0)
