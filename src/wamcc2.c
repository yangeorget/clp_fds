...
label(1)
      switch_on_constant(1,"[($get_bc_reg,3),($cut,5),($dbg_true,7),(pragma_c,9),(calling_module_nb,11),(=,13),(var,15),(nonvar,17),(atom,19),(integer,21),(number,23),(atomic,25),(compound,27),(callable,29),(functor,31),(arg,33),(compare,35),(=..,37),(==,39),(\==,41),(@<,43),(@=<,45),(@>,47),(@>=,49),(is,51),(=:=,53),(=\=,55),(<,57),(=<,59),(>,61),(>=,63),(g_assign,65),(g_assignb,67),(g_link,69),(g_read,71),(g_array_size,73),($fd_set_AF,75),($fd_fv,77),($fd_fp,79),($fd_cstr,81)]")
...
Begin_Init_Tables(wamcc2)
 ...
 Define_Switch_CST_Table(Swt_Table_Name(X696E6C696E655F707265646963617465,3,1,cst),40)
     ...
     Define_Switch_CST(X2466645F7365745F4146,Label_Pred_Name(X696E6C696E655F707265646963617465,3,75))
     Define_Switch_CST(X2466645F6676,Label_Pred_Name(X696E6C696E655F707265646963617465,3,77))
     Define_Switch_CST(X2466645F6670,Label_Pred_Name(X696E6C696E655F707265646963617465,3,79))
     Define_Switch_CST(X2466645F63737472,Label_Pred_Name(X696E6C696E655F707265646963617465,3,81))
