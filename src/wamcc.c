...
Begin_Public_Pred
      ...
      put_y_value(3,0)
      put_y_variable(1,1)
      call(Pred_Name(X6E616D65,2),0,4,"name",2)          /* begin sub 4 */
      put_constant(X7E73202D2056657273696F6E207E737E6E,0,"~s - Version ~s~n")
      put_list(2)
      ...
      put_constant(X44616E69656C204469617A2C2059616E2047656F726765747E6E,0,"Daniel Diaz, Yan Georget~n")
      put_nil(1)
      call(Pred_Name(X666F726D617461,2),0,6,"formata",2)          /* begin sub 6 */
      put_constant(X7E64202D20494E52494120526F637175656E636F757274202D204C4F434F2050726F6A6563747E6E,0,"~d - INRIA Rocquencourt - LOCO Project~n")
      put_list(1)
...
label(4)
      ...
      unify_x_variable(1)
      unify_y_variable(0)
      get_structure(X636C636F6D70,4,1,"clcomp")
      unify_y_variable(5)
      unify_y_variable(10)
      unify_y_variable(4)
      unify_y_variable(3)
      ...
      put_y_variable(7,3)
      put_y_variable(1,4)
      call(Pred_Name(X73756372655F73796E74617869717565,5),0,1,"sucre_syntaxique",5)          /* begin sub 1 */
      cut_y(2)
      put_y_value(11,0)
      put_y_value(10,1)
      put_y_variable(9,2)
      ...
      put_y_value(4,5)
      put_y_value(3,6)
      call(Pred_Name(X67656E65726174696F6E5F636F6465,7),0,4,"generation_code",7)          /* begin sub 4 */
      cut_y(2)
      put_y_value(4,0)
      call(Pred_Name(X616C6C6F636174696F6E5F7661727358,1),0,5,"allocation_varsX",1)          /* begin sub 5 */
      cut_y(2)
      put_y_value(3,0)
      call(Pred_Name(X657865635F66645F616C6C6F636174696F6E,1),1,6,"exec_fd_allocation",1)          /* begin sub 6 */
      cut_y(2)
      put_y_unsafe_value(1,0)
      put_y_value(0,1)
      deallocate
...
#define ASCII_PRED "exec_fd_allocation"
#define PRED       X657865635F66645F616C6C6F636174696F6E
#define ARITY      1
...
label(4)
      ...
      unify_x_variable(0)
      unify_void(1)
      call(Pred_Name(X616C6C6F636174696F6E5F7661727358,1),0,1,"allocation_varsX",1)          /* begin sub 1 */
      put_y_value(0,0)
      deallocate
      execute(Pred_Name(X657865635F66645F616C6C6F636174696F6E,1),1,"exec_fd_allocation",1)
...
label(5)
      ...
      unify_x_value(5)
      get_x_value(4,3)
      call(Pred_Name(X666F726D61745F696E646578,3),1,2,"format_index",3)          /* begin sub 2 */
      put_y_value(2,0)
      put_y_value(1,1)
      put_y_value(0,2)
      deallocate
...
Begin_Init_Tables(wamcc)
 ...
 Define_Atom(X7E73202D2056657273696F6E207E737E6E,"~s - Version ~s~n")
 Define_Atom(X44616E69656C204469617A2C2059616E2047656F726765747E6E,"Daniel Diaz, Yan Georget~n")
 Define_Atom(X7E64202D20494E52494120526F637175656E636F757274202D204C4F434F2050726F6A6563747E6E,"~d - INRIA Rocquencourt - LOCO Project~n")
 ...
 Define_Atom(X657865635F66645F616C6C6F636174696F6E,"exec_fd_allocation")
 ...
 Define_Pred(X657865635F66645F616C6C6F636174696F6E,1,0)
