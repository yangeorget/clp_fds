...
#define ASCII_PRED "list_of"
#define PRED       X6C6973745F6F66
#define ARITY      2
...
label(4)
      ...
      get_x_value(2,1)
      put_x_value(2,1)
      execute(Pred_Name(X6C6973745F6F66,2),1,"list_of",2)
...
#define ASCII_PRED "interval2list"
#define PRED       X696E74657276616C326C697374
#define ARITY      3
...
Begin_Public_Pred
      ...
      function_1(inc,1,0)
      put_y_value(1,0)
      call(Pred_Name(X6C656E677468,2),1,1,"length",2)          /* begin sub 1 */
      put_y_value(1,0)
      put_y_value(0,1)
      deallocate
      execute(Pred_Name(X6D6B5F6C697374,2),1,"mk_list",2)
...
#define ASCII_PRED "mk_list"
#define PRED       X6D6B5F6C697374
#define ARITY      2
...
#define ASCII_PRED "lines_to_columns"
#define PRED       X6C696E65735F746F5F636F6C756D6E73
#define ARITY      2
...
label(2)
      ...
      unify_y_variable(0)
      put_y_variable(1,2)
      call(Pred_Name(X6372656174655F636F6C756D6E,3),1,1,"create_column",3)          /* begin sub 1 */
      put_y_unsafe_value(1,0)
      put_y_value(0,1)
      deallocate
      execute(Pred_Name(X6C696E65735F746F5F636F6C756D6E73,2),1,"lines_to_columns",2)
...
#define ASCII_PRED "create_column"
#define PRED       X6372656174655F636F6C756D6E
#define ARITY      3
...
label(4)
      ...
      unify_x_value(3)
      unify_x_variable(2)
      execute(Pred_Name(X6372656174655F636F6C756D6E,3),1,"create_column",3)
...
#define ASCII_PRED "ll_append"
#define PRED       X6C6C5F617070656E64
#define ARITY      2

Begin_Public_Pred
      execute(Pred_Name(X617070656E64,2),1,"append",2)
...
#define ASCII_PRED "ll_length"
#define PRED       X6C6C5F6C656E677468
#define ARITY      2
...
label(4)
      ...
      put_y_value(0,1)
      deallocate
      execute(Pred_Name(X6C6C5F6C656E677468,2),1,"ll_length",2)
...
label(7)
      ...
      put_x_value(2,1)
      put_y_variable(2,2)
      call(Pred_Name(X617070656E64,3),1,2,"append",3)          /* begin sub 2 */
      put_list(0)
...
Begin_Init_Tables(list)
 ...
 Define_Atom(X5B5D,"[]")
 Define_Atom(X6C6973745F6F66,"list_of")
 Define_Atom(X696E74657276616C326C697374,"interval2list")
 Define_Atom(X6D6B5F6C697374,"mk_list")
 Define_Atom(X6C696E65735F746F5F636F6C756D6E73,"lines_to_columns")
 Define_Atom(X6372656174655F636F6C756D6E,"create_column")
 Define_Atom(X6C6C5F617070656E64,"ll_append")
 Define_Atom(X6C6C5F6C656E677468,"ll_length")
 ...
 Define_Pred(X6C6973745F6F66,2,1)

 Define_Pred(X696E74657276616C326C697374,3,1)

 Define_Pred(X6D6B5F6C697374,2,0)

 Define_Pred(X6C696E65735F746F5F636F6C756D6E73,2,1)

 Define_Pred(X6372656174655F636F6C756D6E,3,0)

 Define_Pred(X6C6C5F617070656E64,2,1)

 Define_Pred(X6C6C5F6C656E677468,2,1)

 Define_Pred(X617070656E64,2,1)
