...
label(2)
      ...
      put_x_variable(0,1)
      builtin_3(arg,3,2,1)
      call(Pred_Name(X6E6F6E5F616E795F766172,1),1,1,"non_any_var",1)          /* begin sub 1 */
      cut_y(3)
...
Begin_Private_Pred
      ...
      get_y_bc_reg(0)
      put_y_value(1,0)
      call(Pred_Name(X616E795F766172,1),1,1,"any_var",1)          /* begin sub 1 */
      put_y_value(3,0)
      put_y_value(1,1)
      call(Pred_Name(X7465726D5F69735F667265655F6F66,2),1,2,"term_is_free_of",2)          /* begin sub 2 */
      put_y_value(2,0)
      put_y_value(1,1)
      call(Pred_Name(X6C6973745F69735F667265655F6F66,2),1,3,"list_is_free_of",2)          /* begin sub 3 */
      cut_y(0)
      deallocate
      proceed
...
label(1)
      ...
      get_x_value(2,3)
      get_y_bc_reg(0)
      call(Pred_Name(X616E795F766172,1),1,4,"any_var",1)          /* begin sub 4 */
      cut_y(0)
      deallocate
      proceed
...
label(2)
      ...
      put_y_variable(3,2)
      put_y_variable(2,3)
      call(Pred_Name(X6578706C696369745F62696E64696E67,4),1,5,"explicit_binding",4)          /* begin sub 5 */
      cut_y(4)
...
#define ASCII_PRED "any_var"
#define PRED       X616E795F766172
#define ARITY      1
...
label(1)
      trust_me_else_fail
      execute(Pred_Name(X66645F766172,1),0,"fd_var",1)
...
#define ASCII_PRED "non_any_var"
#define PRED       X6E6F6E5F616E795F766172
#define ARITY      1

Begin_Private_Pred
      builtin_1(nonvar,0)
      execute(Pred_Name(X6E6F6E5F616E795F7661725F2461757832,1),1,"non_any_var_$aux2",1)
...
#define ASCII_PRED "non_any_var_$aux2"
#define PRED       X6E6F6E5F616E795F7661725F2461757832
#define ARITY      1
...
Begin_Private_Pred
      ...
      allocate(1)
      get_y_bc_reg(0)
      call(Pred_Name(X66645F766172,1),0,1,"fd_var",1)          /* begin sub 1 */
      cut_y(0)
      fail
...
Begin_Init_Tables(setof)
 ...
 Define_Atom(X616E795F766172,"any_var")
 Define_Atom(X6E6F6E5F616E795F766172,"non_any_var")
 Define_Atom(X6E6F6E5F616E795F7661725F2461757832,"non_any_var_$aux2")
 ...
 Define_Pred(X616E795F766172,1,0)

 Define_Pred(X6E6F6E5F616E795F766172,1,0)

 Define_Pred(X6E6F6E5F616E795F7661725F2461757832,1,0)
