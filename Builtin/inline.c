...
Begin_Public_Pred
      ...
      put_x_value(1,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C,2),1,1,"eval",2)          /* begin sub 1 */
      put_y_value(1,0)
      get_y_value(0,0)
      deallocate
      proceed
...
Begin_Public_Pred
      ...
      put_y_value(2,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C,2),1,2,"eval",2)          /* begin sub 2 */
...
Begin_Public_Pred
      ...
      allocate(1)
      get_y_bc_reg(0)
      call(Pred_Name(X6576616C31,2),1,1,"eval1",2)          /* begin sub 1 */
      cut_y(0)
      deallocate
      proceed
...
label(1)
      ...
      allocate(1)
      get_y_variable(0,0)
      put_constant(X4572726F723A20,0,"Error: ")
      call(Pred_Name(X7772697465,1),0,2,"write",1)          /* begin sub 2 */
      put_y_value(0,0)
      call(Pred_Name(X7772697465,1),0,3,"write",1)          /* begin sub 3 */
      put_constant(X20496C6C6567616C2061726974686D657469632065787072657373696F6E,0," Illegal arithmetic expression")
...
label(11)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,2,"eval1",2)          /* begin sub 2 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,3,"eval1",2)          /* begin sub 3 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(13)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,4,"eval1",2)          /* begin sub 4 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,5,"eval1",2)          /* begin sub 5 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(15)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,6,"eval1",2)          /* begin sub 6 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,7,"eval1",2)          /* begin sub 7 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(17)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,8,"eval1",2)          /* begin sub 8 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,9,"eval1",2)          /* begin sub 9 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(19)
      allocate(4)
      get_structure(X6D6F64,2,0,"mod")
      unify_x_variable(0)
      unify_y_variable(3)
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,10,"eval1",2)          /* begin sub 10 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,11,"eval1",2)          /* begin sub 11 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(21)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,12,"eval1",2)          /* begin sub 12 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,13,"eval1",2)          /* begin sub 13 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(23)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,14,"eval1",2)          /* begin sub 14 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,15,"eval1",2)          /* begin sub 15 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
      function_2(or,0,1,0)
      get_y_value(2,0)
...
label(25)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,16,"eval1",2)          /* begin sub 16 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,17,"eval1",2)          /* begin sub 17 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(27)
      ...
      get_y_variable(1,1)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,18,"eval1",2)          /* begin sub 18 */
      math_load_y_value(0,0)
      function_1(not,0,0)
      get_y_value(1,0)
      deallocate
...
label(29)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,19,"eval1",2)          /* begin sub 19 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,20,"eval1",2)          /* begin sub 20 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
...
label(31)
      ...
      get_y_variable(2,1)
      put_y_variable(1,1)
      call(Pred_Name(X6576616C31,2),1,21,"eval1",2)          /* begin sub 21 */
      put_y_value(3,0)
      put_y_variable(0,1)
      call(Pred_Name(X6576616C31,2),1,22,"eval1",2)          /* begin sub 22 */
      math_load_y_value(1,1)
      math_load_y_value(0,0)
