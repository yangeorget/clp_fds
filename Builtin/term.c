...
label(7)
      ...
      put_y_variable(5,3)
      put_y_variable(3,4)
      call(Pred_Name(X73616D72756E,5),1,2,"samrun",5)          /* begin sub 2 */
      ...
      put_y_value(1,1)
      put_y_variable(2,2)
      call(Pred_Name(X73616D66757365,3),1,3,"samfuse",3)          /* begin sub 3 */
...
label(1)
      ...
      put_x_value(3,1)
      put_y_variable(3,2)
      call(Pred_Name(X6D65726765,3),1,1,"merge",3)          /* begin sub 1 */
      put_list(0)
...
label(1)
      ...
      put_y_variable(3,4)
      put_y_variable(2,5)
      call(Pred_Name(X73616D72756E74,6),1,1,"samrunt",6)          /* begin sub 1 */
      cut_y(5)
      put_y_value(4,0)
...
label(7)
      ...
      put_y_variable(5,3)
      put_y_variable(3,4)
      call(Pred_Name(X73616D6B657972756E,5),1,2,"samkeyrun",5)          /* begin sub 2 */
      math_load_y_value(6,0)
      function_1(inc,0,0)
      get_y_variable(1,0)
      put_list(0)
      ...
      put_y_value(1,1)
      put_y_variable(2,2)
      call(Pred_Name(X73616D6B657966757365,3),1,3,"samkeyfuse",3)          /* begin sub 3 */
      put_y_unsafe_value(3,0)
      put_y_unsafe_value(2,1)
      put_y_unsafe_value(1,2)
      put_y_value(0,3)
...
label(1)
      ...
      put_x_value(3,1)
      put_y_variable(3,2)
      call(Pred_Name(X6B65796D65726765,3),1,1,"keymerge",3)          /* begin sub 1 */
      put_list(0)
      unify_y_local_value(3)
      unify_y_value(2)
      put_y_unsafe_value(1,1)
