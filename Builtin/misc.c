...
#define ASCII_PRED "random"
#define PRED       X72616E646F6D
#define ARITY      2
...
#define ASCII_PRED "abs"
#define PRED       X616273
#define ARITY      2

Begin_Public_Pred
      execute(Pred_Name(X6162735F2461757831,2),1,"abs_$aux1",2)
...
#define ASCII_PRED "abs_$aux1"
#define PRED       X6162735F2461757831
#define ARITY      2
...
#define ASCII_PRED "cputime"
#define PRED       X63707574696D65
#define ARITY      1

Begin_Public_Pred
      get_x_variable(2,0)
      put_constant(X72756E74696D65,0,"runtime")
      put_list(1)
      unify_x_local_value(2)
      unify_void(1)
      execute(Pred_Name(X73746174697374696373,2),1,"statistics",2)
...
label(4)
      get_structure(X616363657373,2,0,"access")
      unify_x_variable(0)
      unify_x_variable(1)
...
label(6)
      get_structure(X61726776,1,0,"argv")
      unify_x_variable(0)
...
label(8)
      allocate(1)
      get_constant(X6364,0,"cd")
      put_constant(X484F4D45,0,"HOME")
      put_y_variable(0,1)
      call(Pred_Name(X756E69785F676574656E76,2),1,1,"unix_getenv",2)          /* begin sub 1 */
...
label(12)
      get_structure(X65786974,1,0,"exit")
      unify_x_variable(0)
...
label(14)
      get_structure(X676574656E76,2,0,"getenv")
      unify_x_variable(0)
      unify_x_variable(1)
...
label(16)
      get_constant(X7368656C6C,0,"shell")
      put_x_variable(0,0)
      put_x_variable(1,1)
...
label(18)
      get_structure(X7368656C6C,1,0,"shell")
      unify_x_variable(0)
      put_x_variable(1,1)
      execute(Pred_Name(X756E69785F7368656C6C,2),1,"unix_shell",2)
...
label(20)
      get_structure(X7368656C6C,2,0,"shell")
      unify_x_variable(0)
      unify_x_variable(1)
      execute(Pred_Name(X756E69785F7368656C6C,2),1,"unix_shell",2)
...
label(22)
      get_structure(X73797374656D,1,0,"system")
      unify_x_variable(0)
      put_x_variable(1,1)
...
label(24)
      get_structure(X73797374656D,2,0,"system")
      unify_x_variable(0)
      unify_x_variable(1)
      execute(Pred_Name(X756E69785F73797374656D,2),1,"unix_system",2)
...
Begin_Private_Pred
      ...
      get_y_variable(0,0)
      put_y_variable(1,0)
      call(Pred_Name(X61726763,1),1,1,"argc",1)          /* begin sub 1 */
      put_integer(1,0)
      put_y_unsafe_value(1,1)
      put_y_value(0,2)
      deallocate
...
Begin_Private_Pred
      execute(Pred_Name(X756E69785F61726776315F2461757832,3),1,"unix_argv1_$aux2",3)
...
#define ASCII_PRED "unix_argv1_$aux2"
#define PRED       X756E69785F61726776315F2461757832
#define ARITY      3
...
label(1)
      ...
      put_y_value(1,0)
      put_y_variable(2,1)
      call(Pred_Name(X61726776,2),1,1,"argv",2)          /* begin sub 1 */
      put_y_value(3,0)
      get_list(0)
...
Begin_Private_Pred
      ...
      get_y_bc_reg(5)
      put_y_variable(4,0)
      call(Pred_Name(X756E69785F7368656C6C5F2461757833,1),1,1,"unix_shell_$aux3",1)          /* begin sub 1 */
      cut_y(5)
      put_constant(X6578656320,0,"exec ")
      put_y_value(4,1)
      put_y_variable(2,2)
      ...
      put_y_value(2,1)
      put_y_variable(1,2)
      call(Pred_Name(X756E69785F7368656C6C5F2461757834,3),1,3,"unix_shell_$aux4",3)          /* begin sub 3 */
...
#define ASCII_PRED "unix_shell_$aux4"
#define PRED       X756E69785F7368656C6C5F2461757834
#define ARITY      3
...
Begin_Private_Pred
      try_me_else(1)
      get_x_variable(1,0)
      put_constant(X5348454C4C,0,"SHELL")
      execute(Pred_Name(X756E69785F676574656E76,2),1,"unix_getenv",2)

label(1)
      trust_me_else_fail
      get_constant(X2F62696E2F7368,0,"/bin/sh")
      proceed
...
Begin_Init_Tables(misc)
 ...
 Define_Atom(X5B5D,"[]")
 Define_Atom(X72616E646F6D,"random")
 Define_Atom(X616273,"abs")
 Define_Atom(X6162735F2461757831,"abs_$aux1")
 Define_Atom(X73746174697374696373,"statistics")
 Define_Atom(X63707574696D65,"cputime")
 Define_Atom(X72756E74696D65,"runtime")
 ...
 Define_Atom(X756E69785F61726776315F2461757832,"unix_argv1_$aux2")
 ...
 Define_Atom(X756E69785F7368656C6C5F2461757834,"unix_shell_$aux4")
 ...
 Define_Pred(X72616E646F6D,2,1)

 Define_Pred(X616273,2,1)

 Define_Pred(X6162735F2461757831,2,0)

 Define_Pred(X73746174697374696373,0,1)

 Define_Pred(X73746174697374696373,2,1)

 Define_Pred(X63707574696D65,1,1)
 ...
 Define_Pred(X756E69785F61726776315F2461757832,3,0)
 ...
 Define_Pred(X756E69785F7368656C6C5F2461757834,3,0)

 Define_Pred(X756E69785F7368656C6C5F2461757833,1,0)
